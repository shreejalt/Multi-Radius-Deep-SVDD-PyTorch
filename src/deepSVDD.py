...
class DeepSVDD(object):
    ...
    def __init__(self, objective: str = 'one-class', nu: float = 0.1, use_multi_radius: bool = False):
        ...
        self.use_multi_radius = use_multi_radius # Train multi radius model
    ...
    def train(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
        ...
        self.trainer = DeepSVDDTrainer(self.objective, self.R, self.c, self.nu, optimizer_name, lr=lr,
                                       ...
                                       weight_decay=weight_decay, device=device, n_jobs_dataloader=n_jobs_dataloader, use_multi_radius=self.use_multi_radius, normal_classes=dataset.normal_classes)
        # Get the model
        self.net = self.trainer.train(dataset, self.net)
        self.R = self.trainer.R.cpu().data.numpy().astype(np.float32) # get float array
    ...
    def pretrain(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
        ...
        self.ae_trainer = AETrainer(optimizer_name, lr=lr, n_epochs=n_epochs, lr_milestones=lr_milestones,
                                    ...
                                    n_jobs_dataloader=n_jobs_dataloader, normal_classes=dataset.normal_classes, use_multi_radius=self.use_multi_radius)
